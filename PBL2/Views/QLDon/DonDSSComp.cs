...
{
    public partial class DonDSSComp : UserControl
    {
        //presenter
        ...
        public DonDSSComp(HoaDon hoaDon, QLDonPresenter menuPagePresenter)
        {
            InitializeComponent();
            ...
            this.labelTrangThai.Text = "Sẵn sàng";

        }

        private void ThanhToanBtn_Click(object sender, EventArgs e)
        {
            this.Presenter.daPhucVu(this.hoaDon);
        }
