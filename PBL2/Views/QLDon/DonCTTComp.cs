...
{
    public partial class DonCTTComp : UserControl
    {
        //presenter
        ...
        public DonCTTComp(HoaDon hoaDon, QLDonPresenter menuPagePresenter)
        {
            InitializeComponent();
            ...
            this.labelThanhTien.DataBindings.Add("Text", this.hoaDon, "ThanhTien", true, DataSourceUpdateMode.OnPropertyChanged, "0", "#,##0 VNĐ");
